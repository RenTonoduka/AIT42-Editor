/**
 * EnsembleDialog - Claude Code Ensemble Mode (Collaborative)
 *
 * Launches multiple Claude Code instances in parallel using Git worktrees
 * and integrates their results using an AI integration agent.
 */
...
/**
 * EnsembleDialog component
 */
export const EnsembleDialog: React.FC<EnsembleDialogProps> = ({
  isOpen,
  onClose,
  onStart,
}) => {
  ...
  const handleStart = async () => {
    ...
    try {
      ...
      // For ensemble mode, we use the same backend but with different handling
        ...
        <div className="flex items-center gap-3 px-6 py-4 border-b border-editor-border bg-editor-surface">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-text-tertiary">
              複数のClaude Codeインスタンスを並列実行して統合AIが結果を統合
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-2xl font-bold text-purple-600">{instanceCount}</span>
            </div>
            <input
              type="range"
              min="2"
              ...
              className="w-full h-2 bg-editor-border rounded-lg appearance-none cursor-pointer accent-purple-600"
            />
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-text-tertiary mt-1">
                      アンサンブル完了後もGit worktreeと出力を保持し、後で確認できるようにします
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-editor-border bg-editor-surface">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-6 py-2 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 disabled:from-editor-border disabled:to-editor-border disabled:text-text-tertiary text-white font-semibold rounded-lg transition-all shadow-glow-sm hover:shadow-glow-md"
            >
